            ...
            NegociacaoController = class NegociacaoController {
                ...
                importaDados() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            const negociacoesParaImportar = yield this._negociacaoService.obterNegociacao(isOk);
                            const negociacoesImportadas = this._negociacoes.paraArray();
                            negociacoesParaImportar
                                .filter(negociacao => !negociacoesImportadas.some(importada => negociacao.igual(importada)))
